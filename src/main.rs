...
async fn main() {
    ...
    let cred_routes = Router::new()
        ...
        .route("/wp-content/{*rest}", get(handlers::config_probe))
        .route("/wp-includes/{*rest}", get(handlers::config_probe))
        .route("/.env", get(handlers::config_probe))
        .route("/.env.local", get(handlers::config_probe))
        .route("/.env.production", get(handlers::config_probe))
        .route("/.git/config", get(handlers::config_probe))
        .route("/.git/HEAD", get(handlers::config_probe))
        .route("/phpinfo.php", get(handlers::php_probe))
        .route("/index.php", get(handlers::php_probe))
        .route("/.svn/{*rest}", get(handlers::config_probe))
        .route("/.hg/{*rest}", get(handlers::config_probe))
        .route("/.aws/credentials", get(handlers::config_probe))
        .route("/.ssh/id_rsa", get(handlers::config_probe))
        .route("/.ssh/config", get(handlers::config_probe))
        .route("/actuator/{*rest}", get(handlers::config_probe))
        .route("/_ignition/{*rest}", get(handlers::config_probe))
        .route("/solr/{*rest}", get(handlers::config_probe))
        .route("/server-status", get(handlers::config_probe))
        .route("/server-info", get(handlers::config_probe))
        ...
        .route("/shell.php", get(handlers::php_probe))
        .route("/c99.php", get(handlers::php_probe))
        .route("/r57.php", get(handlers::php_probe))
        .route("/webshell.php", get(handlers::php_probe))
        .route("/pma/{*rest}", get(handlers::config_probe))
        .route("/dbadmin/{*rest}", get(handlers::config_probe))
        .route("/mysql/{*rest}", get(handlers::config_probe))
        .route("/sqlmanager/{*rest}", get(handlers::config_probe))
